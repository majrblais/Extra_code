...
run_dir = f"/home/emb9357/scratch/roads/runs/{args.encoder}_{args.lr}_{args.model}"
...
x_train_dir = "./data/training/img/"
y_train_dir = "./data/training/mask/"

# Set Validation images and mask path
x_valid_dir = "./data/validation/img/"
y_valid_dir = "./data/validation/mask/"
...
# Flow from directory
x_generator = data_generator2.flow_from_directory(directory=x_train_dir, target_size=(512,512), batch_size=4, seed=42, class_mode=None, classes=None)
y_generator = data_generator.flow_from_directory(directory=y_train_dir, target_size=(512,512), batch_size=4, seed=42, class_mode=None, classes=None)

valx_generator = data_generator2.flow_from_directory(directory=x_valid_dir, target_size=(512,512), batch_size=4, seed=42, class_mode=None, classes=None)
valy_generator = data_generator.flow_from_directory(directory=y_valid_dir, target_size=(512,512), batch_size=4, seed=42, class_mode=None, classes=None) 
